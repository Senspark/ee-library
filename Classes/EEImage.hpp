...
#include "EENonConstructible.hpp"
 ...
 */
void boxBlur1D(cocos2d::Image* image, unsigned range, unsigned iterations = 1);

/**
 * Tent blur.
 * Equal to two iterations of box blur.
 */
void tentBlur1D(cocos2d::Image* image, unsigned range, unsigned iterations = 1);
