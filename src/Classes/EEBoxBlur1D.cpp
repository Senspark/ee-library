...
namespace image {
NS_ANONYMOUS_BEGIN
void internalBoxBlur1D(ChannelType* pixels,
    ...
    auto sumR = new SizeType[width + 1]; sumR[0] = 0;
    auto sumG = new SizeType[width + 1]; sumG[0] = 0;
    auto sumB = new SizeType[width + 1]; sumB[0] = 0;
    ...
    auto updatePixel = [&](SizeType size) noexcept {
        ...
        *newPixel++ = static_cast<ChannelType>(((*sumInB - *sumOutB) * num) >> Bits);
