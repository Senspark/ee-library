...
void CheckBoxBase::setOnStateChangedCallback(const StateChangedCallback& callback) {
...
bool CheckAllBox::all() const {
    return std::all_of(checkBoxes_.cbegin(),
                       checkBoxes_.cend(),
                       [](CheckBox* box) {
...
bool CheckAllBox::any() const {
    return std::any_of(checkBoxes_.cbegin(),
                       checkBoxes_.cend(),
                       [](CheckBox* box) {
                           return box->isChecked();
                       });
...
bool CheckAllBox::none() const {
    return std::none_of(checkBoxes_.cbegin(),
                        checkBoxes_.cend(),
                        [](CheckBox* box) {
                            return box->isChecked();
                        });
...
void CheckAllBox::updateState() {
    bool newState = std::all_of(checkBoxes_.cbegin(),
                                checkBoxes_.cend(),
                                [](CheckBox* box) {
                                    return box->isChecked();
                                });
