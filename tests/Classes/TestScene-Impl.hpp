...
class TestScene::Impl : public TestScene,
...
public:
    ...
    virtual bool
    onAssignCCBCustomProperty(cocos2d::Ref* pTarget,
                              const char* pMemberVariableName,
    ...
    virtual cocos2d::SEL_CallFuncN
    onResolveCCBCCCallFuncSelector(cocos2d::Ref* pTarget,
                                   const char* pSelectorName) override {
        return nullptr;
    }
    ...
    void pressed1pxButton(cocos2d::Ref*,
                          cocos2d::extension::Control::EventType);
    void pressed2pxButton(cocos2d::Ref*,
                          cocos2d::extension::Control::EventType);
    void pressed4pxButton(cocos2d::Ref*,
                          cocos2d::extension::Control::EventType);
    void pressed8pxButton(cocos2d::Ref*,
                          cocos2d::extension::Control::EventType);
    void pressed16pxButton(cocos2d::Ref*,
                           cocos2d::extension::Control::EventType);
    void pressed32pxButton(cocos2d::Ref*,
                           cocos2d::extension::Control::EventType);
    void pressed64pxButton(cocos2d::Ref*,
                           cocos2d::extension::Control::EventType);
    void pressed128pxButton(cocos2d::Ref*,
                            cocos2d::extension::Control::EventType);
    void pressed256pxButton(cocos2d::Ref*,
                            cocos2d::extension::Control::EventType);

    void pressedBoxBlur1D(cocos2d::Ref*,
                          cocos2d::extension::Control::EventType);
    void pressedBoxBlur1Dx2(cocos2d::Ref*,
                            cocos2d::extension::Control::EventType);
    void pressedBoxBlur2D(cocos2d::Ref*,
                          cocos2d::extension::Control::EventType);
    void pressedTentBlur1D(cocos2d::Ref*,
                           cocos2d::extension::Control::EventType);
